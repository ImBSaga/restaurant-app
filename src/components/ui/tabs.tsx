...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        "bg-neutral-100 text-neutral-950 inline-flex font-bold text-sm h-12 w-full items-center justify-center rounded-lg p-1.5",
        className
      )}
      {...props}
    />
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "text-neutral-600 data-[state=active]:text-neutral-950",
